...
<div class="wp-block-group"><!-- wp:separator {"className":"is-style-default"} -->
    ...
    <!-- wp:heading {"textAlign":"center","level":5,"style":{"spacing":{"margin":{"bottom":"var:preset|spacing|30"}}}} -->
    <h5 class="wp-block-heading has-text-align-center">
        A Little about myself
    </h5>
    <!-- /wp:heading -->

    <!-- wp:paragraph {"style":{"spacing":{"padding":{"top":"var:preset|spacing|30"}}},"fontSize":"small"} -->
    <p class="has-small-font-size" style="padding-top:var(--wp--preset--spacing--30)">
